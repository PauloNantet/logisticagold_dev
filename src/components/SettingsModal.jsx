...
export default function SettingsModal({ settings, onSave, onClose }) {
  ...
  const handleLogoChange = (file) => {
    ...
    reader.onload = () => handleChange("empresa", "logo", reader.result);
      ...
      <div className="modal-container">
        ...
        <form onSubmit={handleSubmit} className="modal-body">
          <div className="modal-section">
            ...
            <div className="form-row-3">
              <div>
                ...
                <input 
                  type="text" 
                  value={formData.empresa.documento || ""} 
                  onChange={(e) => handleChange("empresa", "documento", formatDoc(e.target.value))}
          ...
          <div className="modal-section border-top">
            <h3 className="settings-section-title gold-text">Dados de Recebimento (PIX)</h3>
            ...
            <div className="pix-config-container" style={{ marginBottom: '12px' }}>
              ...
              <div className="pix-row">
                <select 
                  value={formData.pagamento.tipoPix || "aleatoria"} 
                  onChange={(e) => {
                    const tipo = e.target.value;
                    handleChange("pagamento", "tipoPix", tipo);
                    handleChange("pagamento", "pix", ""); // Limpa ao trocar tipo
                  }}
                  className="custom-input pix-type-select"
                >
                ...
                <input 
                  ...
                  placeholder={
                    formData.pagamento.tipoPix === "cpf" ? "000.000.000-00" :
                    formData.pagamento.tipoPix === "cnpj" ? "00.000.000/0000-00" :
                    formData.pagamento.tipoPix === "celular" ? "+55 (00) 00000-0000" :
                    formData.pagamento.tipoPix === "email" ? "seu@email.com" : "Chave aleatória"
                  }
                  className="custom-input"
                  style={{ flex: 1 }}
                />
            ...
            <div className="settings-grid">
              <div className="input-group">
                ...
                <input 
                  type="text" 
                  value={formData.pagamento.nome} 
                  onChange={(e) => handleChange("pagamento", "nome", e.target.value)}
              ...
              <div className="input-group">
                ...
                <input 
                  type="text" 
                  value={formData.pagamento.cidade} 
                  onChange={(e) => handleChange("pagamento", "cidade", e.target.value)}
          ...
          <div className="modal-section border-top">
            <h3 className="settings-section-title gold-text">Aparência da Fatura</h3>
            <div className="settings-grid">
              <div className="input-group">
...
<label className="radio-label">
                    <input 
                      ...
                      name="tema" 
                      value="gold-text" 
                      checked={formData.tema === "gold-text"}
                      onChange={(e) => setFormData(prev => ({ ...prev, tema: e.target.value }))}
                    />
                    Gold
                  </label>
